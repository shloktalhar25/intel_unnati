...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_5_rag\Codebase\english_literature" # modified this
...
def build_prompt(question, docs): # modify this
    ...
    prompt = f""" 
You are a english subject expert. Use the context below to answer the question factually and directly. 
...
Answer in 2-3 crisp sentences, suitable for a Class 5 english answer.
"""
    return prompt.strip()
