...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_5_rag\Codebase\evs" # modified this
COLLECTION_NAME = "evs_books" # modify this
...
def build_prompt(question, docs): # modify this
    ...
    prompt = f""" 
You are a evs subject expert. Use the context below to answer the question factually and directly. 
...
Answer in 2-3 crisp sentences, suitable for a Class 5 evs answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 evs Q&A Chat (Chroma + Groq)") # modify this
