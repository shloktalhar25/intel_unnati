...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_8_rag\Codebase\history" # modified this
...
Answer in 2-3 crisp sentences, suitable for a Class 8 history answer.
"""
    return prompt.strip()
