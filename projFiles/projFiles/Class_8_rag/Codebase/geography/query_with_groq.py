...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_8_rag\Codebase\geography" # modified this
...
Answer in 2-3 crisp sentences, suitable for a Class 8 geography answer.
"""
    return prompt.strip()
