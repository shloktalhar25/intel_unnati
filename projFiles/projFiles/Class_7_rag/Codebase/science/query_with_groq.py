...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_7_rag\Codebase\science" # modified this
...
Answer in 2-3 crisp sentences, suitable for a Class 7 science answer.
"""
    return prompt.strip()
