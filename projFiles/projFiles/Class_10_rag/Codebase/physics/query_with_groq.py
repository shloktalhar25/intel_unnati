...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_10_rag\Codebase\physics" # modified this
COLLECTION_NAME = "physics_books" # this as well
...
Answer in 2-3 crisp sentences, suitable for a Class 10 physics answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 physics Q&A Chat (Chroma + Groq)")
