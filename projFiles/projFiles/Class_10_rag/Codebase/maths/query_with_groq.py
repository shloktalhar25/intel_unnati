...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_10_rag\Codebase\maths" # modified this
COLLECTION_NAME = "maths_books" # this as well
...
Answer in 2-3 crisp sentences, suitable for a Class 10 maths answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 maths Q&A Chat (Chroma + Groq)")
