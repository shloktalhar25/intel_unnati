...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_10_rag\Codebase\civics" # modified this
COLLECTION_NAME = "civics_books" # this as well
...
def build_prompt(question, docs):
    ...
    prompt = f"""
You are a civics subject expert. Use the context below to answer the question factually and directly.
...
Answer in 2-3 crisp sentences, suitable for a Class 10 civics answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 civics Q&A Chat (Chroma + Groq)")
