...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_10_rag\Codebase\english_literature" # modified this
COLLECTION_NAME = "english_books" # this as well
...
Answer in 2-3 crisp sentences, suitable for a Class 10 english answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 english Q&A Chat (Chroma + Groq)")
