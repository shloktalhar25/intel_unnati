...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_10_rag\Codebase\chemistry" # modified this
COLLECTION_NAME = "chemistry_books" # this as well
...
Answer in 2-3 crisp sentences, suitable for a Class 10 chemistry answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 chemistry Q&A Chat (Chroma + Groq)")
