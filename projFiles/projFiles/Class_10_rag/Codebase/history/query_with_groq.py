...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_10_rag\Codebase\history" # modified this
COLLECTION_NAME = "history_books" # this as well
...
def build_prompt(question, docs):
    ...
    prompt = f"""
You are a history subject expert. Use the context below to answer the question factually and directly.
...
Answer in 2-3 crisp sentences, suitable for a Class 10 history answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 history Q&A Chat (Chroma + Groq)")
