...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_6_rag\Codebase\science" # modified this
COLLECTION_NAME = "science_books" # this as well
...
def build_prompt(question, docs):
    ...
    prompt = f"""
You are a science subject expert. Use the context below to answer the question factually and directly.
...
Answer in 2-3 crisp sentences, suitable for a Class 6 science answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 science Q&A Chat (Chroma + Groq)")
