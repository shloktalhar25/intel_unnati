...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_6_rag\Codebase\social_science" # modified this
COLLECTION_NAME = "social_science_books" # this as well
...
def build_prompt(question, docs):
    ...
    prompt = f"""
You are a social_science subject expert. Use the context below to answer the question factually and directly.
...
Answer in 2-3 crisp sentences, suitable for a Class 6 social_science answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 social_science Q&A Chat (Chroma + Groq)")
