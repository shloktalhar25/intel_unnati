...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_9_rag\Codebase\physics" # modified this
COLLECTION_NAME = "physics_books" # modify this
...
def build_prompt(question, docs): # modify this
    ...
    prompt = f""" 
You are a physics subject expert. Use the context below to answer the question factually and directly. 
...
Answer in 4-5 crisp sentences, suitable for a Class 9 physics answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 physics Q&A Chat (Chroma + Groq)") # modify this
