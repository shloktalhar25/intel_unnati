...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_9_rag\Codebase\biology" # modified this
...
Answer in 2-3 crisp sentences, suitable for a Class 9 biology answer.
"""
    return prompt.strip()
