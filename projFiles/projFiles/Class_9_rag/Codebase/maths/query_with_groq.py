...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_9_rag\Codebase\maths" # modified this
COLLECTION_NAME = "maths_books" # modify this
...
def build_prompt(question, docs): # modify this
    ...
    prompt = f""" 
You are a maths subject expert. Use the context below to answer the question factually and directly. 
...
Answer in 4-5 crisp sentences, suitable for a Class 9 maths answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 maths Q&A Chat (Chroma + Groq)") # modify this
