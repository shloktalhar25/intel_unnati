...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_9_rag\Codebase\chemistry" # modified this
COLLECTION_NAME = "chemistry_books" # modify this
...
def build_prompt(question, docs): # modify this
    ...
    prompt = f""" 
You are a chemistry subject expert. Use the context below to answer the question factually and directly. 
...
Answer in 2-3 crisp sentences, suitable for a Class 9 chemistry answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 chemistry Q&A Chat (Chroma + Groq)") # modify this
