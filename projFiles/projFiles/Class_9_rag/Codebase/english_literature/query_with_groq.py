...
# ---------------- CONFIG ----------------
PERSIST_DIR = r"C:\Users\shlok\Desktop\intel unnati\projFiles\Class_9_rag\Codebase\english_literature" # modified this
COLLECTION_NAME = "english_books" # modify this
...
def build_prompt(question, docs): # modify this
    context = "\n\n".join(
        [f"Source: {d['meta']['source']}\n{d['text']}" for d in docs]
    )
    prompt = f""" 
You are a english literature subject expert. Use the context below to answer the question factually and directly. 
If the answer is clearly suggested or implied, explain it concisely.
I want you to become creative and take the initiative to explain the text fromt the reference of the pdf to you .
...
Answer in 4-5 crisp sentences, suitable for a Class 9 english answer.
"""
    return prompt.strip()
...
def main():
    print("🧠 english Q&A Chat (Chroma + Groq)") # modify this
